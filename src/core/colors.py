...
COLOR_PARKING_TRANSPARENT = pygame.Color(66, 62, 64, 64)    # 25% opacity
COLOR_SHOULDER_TRANSPARENT = pygame.Color(46, 52, 54, 64)   # 25% opacity
...
COLOR_LANE_BACKGROUND = color = pygame.Color(8, 1, 25, 128)  # 50% opacity